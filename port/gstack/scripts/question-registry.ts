/**
 * Question Registry — typed schema for ask the user in chat invocations across gstack.
 *
 * Purpose
 * -------
 * Every ask the user in chat invocation is tagged with a stable question_id that maps
 ...
 *
 * Not every ask the user in chat in gstack needs a registry entry right away. Skills
...
export const QUESTIONS = {
  ...
  'preamble-routing-injection': {
    ...
    description: "Add gstack skill routing rules to AGENTS.md?",
  },
