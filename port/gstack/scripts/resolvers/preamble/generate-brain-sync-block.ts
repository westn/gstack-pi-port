 ...
 * stop-gate via ask the user in chat when gbrain_sync_mode is unset and gbrain
...
${isBrainHost ? `If output shows \`BRAIN_SYNC: brain repo detected\`, offer \`gstack-brain-restore\` via ask the user in chat; otherwise continue.` : ''}
