...
# /skill:cso — Chief Security Officer Audit
...
## Arguments
- `/skill:cso` — full security audit of the codebase
- `/skill:cso --diff` — security review of current branch changes only
- `/skill:cso --scope auth` — focused audit on a specific domain
- `/skill:cso --owasp` — OWASP Top 10 focused assessment
- `/skill:cso --supply-chain` — dependency and supply chain risk only
...
For the top 5 findings, present via ask the user in chat:
