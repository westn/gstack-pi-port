...
const factory: HostConfig = {
  ...
  pathRewrites: [
    { from: '~/.pi/agent/skills/gstack', to: '$GSTACK_ROOT' },
    { from: '.pi/skills/gstack', to: '.factory/skills/gstack' },
    { from: '.pi/skills/review', to: '.factory/skills/gstack/review' },
    { from: '.pi/skills', to: '.factory/skills' },
  ],
  toolRewrites: {
