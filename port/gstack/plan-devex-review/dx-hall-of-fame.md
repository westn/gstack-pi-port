...
## pi Skill DX Checklist

Use when reviewing plans for pi skills, MCP servers, or AI agent tools.

- [ ] **ask the user in chat design**: One issue per call. Re-ground context (project, branch, task). Browser handoff for visual feedback.
