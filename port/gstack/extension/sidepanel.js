 ...
 * in favor of the interactive REPL — no more one-shot pi --mode json -p.
 *
...
inspectorSendBtn.addEventListener('click', () => {
  ...
  // spawned a one-shot pi --mode json -p (sidebar-agent.ts is gone).
 ...
 * pi --mode json -p) — we have a live REPL now, so route through that instead.
 */
