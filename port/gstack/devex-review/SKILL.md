...
description: |
  ...
  scorecard with evidence. Compares against /skill:plan-devex-review scores if they
...
# /skill:devex-review: Live Developer Experience Audit
...
If URLs are missing, ask the user in chat: "What's the URL for the docs/product I should test?"

### Boomerang Baseline

Check for prior /skill:plan-devex-review scores:
...
If /skill:plan-devex-review scores exist from the baseline check:
...
```bash
~/.pi/agent/skills/gstack/bin/gstack-learnings-log '{"skill":"devex-review","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
- Re-run /skill:devex-review after fixes to verify improvement
- If boomerang showed significant gaps, re-run /skill:plan-devex-review on the next feature plan
