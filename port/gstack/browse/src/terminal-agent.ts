/**
 * Terminal Agent — PTY-backed pi terminal for the gstack browser
          ...
          if (!proc) {
            try {
              ws.send(JSON.stringify({
                ...
                message: 'claude CLI not on PATH. Install: https://www.npmjs.com/package/@mariozechner/pi-coding-agent',
              }));
