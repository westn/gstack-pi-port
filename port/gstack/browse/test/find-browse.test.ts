...
describe('locateBinary', () => {
  test('returns null when no binary exists at known paths', () => {
    ...
    // ~/.pi/agent/skills/gstack/browse/dist/browse, it will find it.
  ...
  test('priority chain checks .codex, .agents, .pi markers', () => {
    ...
    // The markers array should list .codex first, then .agents, then .pi
