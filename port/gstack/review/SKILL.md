...
- If CRITICAL issues found: output all findings, then for EACH critical issue use a separate ask the user in chat with the problem, your recommended fix, and options (A: Fix it now, B: Acknowledge, C: False positive — skip).
