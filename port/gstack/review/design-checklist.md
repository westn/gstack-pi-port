...
- **[LOW]** — Requires understanding visual intent. Present as: "Possible issue — verify visually or run /skill:design-review."
...
**LOW confidence items** → present as "Possible: [description]. Verify visually or run /skill:design-review." Never AUTO-FIX.
...
- [file:line] Possible issue — verify with /skill:design-review
```
