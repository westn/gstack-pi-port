...
Shared reference for the canonical TODOS.md format. Referenced by `/skill:ship` (Step 5.5) and `/skill:plan-ceo-review` (TODOS.md updates section) to ensure consistent TODO item structure.
