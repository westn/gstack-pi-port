...
- Brainstorming → /skill:office-hours
- Strategy → /skill:plan-ceo-review
- Architecture → /skill:plan-eng-review
- Design → /skill:plan-design-review or /skill:design-consultation
- Auto-review → /skill:autoplan
- Debugging → /skill:investigate
- QA → /skill:qa
- Code review → /skill:review
- Visual audit → /skill:design-review
- Shipping → /skill:ship
- Docs → /skill:document-release
- Retro → /skill:retro
- Second opinion → /skill:codex
- Prod safety → /skill:careful or /skill:guard
- Scoped edits → /skill:freeze or /skill:unfreeze
- Upgrades → /skill:gstack-upgrade
