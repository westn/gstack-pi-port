...
description: |
  ...
  Also suggest adjacent gstack skills by stage: brainstorm /skill:office-hours; strategy
  /skill:plan-ceo-review; architecture /skill:plan-eng-review; design /skill:plan-design-review or
  /skill:design-consultation; auto-review /skill:autoplan; debugging /skill:investigate; QA /skill:qa; code review
  /skill:review; visual audit /skill:design-review; shipping /skill:ship; docs /skill:document-release; retro
  /skill:retro; second opinion /skill:codex; prod safety /skill:careful or /skill:guard; scoped edits /skill:freeze or
  /skill:unfreeze; gstack upgrades /skill:gstack-upgrade. If the user opts out of suggestions, stop
