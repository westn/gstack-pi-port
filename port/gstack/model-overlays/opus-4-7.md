...
`STOP. ask the user in chat` anywhere, pace one question per turn — emit the question as
...
skill has no `STOP. ask the user in chat` directive AND (b) you need multiple unrelated
