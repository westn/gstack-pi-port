...
- `/skill:learn` (no arguments) → **Show recent**
- `/skill:learn search <query>` → **Search**
- `/skill:learn prune` → **Prune**
- `/skill:learn export` → **Export**
- `/skill:learn stats` → **Stats**
- `/skill:learn add` → **Manual add**
...
"No learnings recorded yet. As you use /skill:review, /skill:ship, /skill:investigate, and other skills,
...
Present each flagged entry via ask the user in chat:
...
The user wants to manually add a learning. Use ask the user in chat to gather:
