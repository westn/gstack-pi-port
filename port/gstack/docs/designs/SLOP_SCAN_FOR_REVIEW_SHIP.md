# Design: slop-scan integration in /skill:review and /skill:ship
...
### /skill:review (Step 4, after checklist pass)
...
### /skill:ship (Step 3.5, pre-landing review + PR body)

Same integration as /skill:review. Additionally, show a one-line summary in the PR body:
