...
- Shows: "Want to make more changes? Run `/skill:design-shotgun` again."
...
- Shows: "Run `/skill:design-shotgun` again in your coding agent."
...
### 9. The ask the user in chat Redundancy
...
**Fix:** The skill template must say: "Do NOT ask the user in chat to ask the user's
preference. Read `feedback.json`, it contains their selection. Only ask the user in chat
...
3. Agent uses ask the user in chat: "I've opened the design board. Which variant
