...
- PR quality score (0-10) logged per review + /skill:retro trending
...
- E7: Specialist performance tracking, log per-specialist metrics via gstack-review-log.
  Timeline integration: specialist runs appear in timeline.jsonl for /skill:retro trending.
...
- Trust signals: consecutive clean reviews (per class), /skill:health score stability,
...
**Scope assessment:**
- TINY/SMALL/MEDIUM/LARGE classification in /skill:review, /skill:ship, /skill:autoplan based on
...
/skill:health scores, clean review history, and timeline patterns are useful signals.
...
- /skill:health score correlation with actual code quality (do high scores predict
