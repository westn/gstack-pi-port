...
pi's context window is ephemeral. Every session starts fresh. When
...
```
                   ...
                   ┌──────────────▼──────────────────────┐
                   │           /skill:retro                      │
                   │  Timeline: 3 /skill:review, 2 /skill:ship, ...   │
...
skill name, branch, key outcome. `/skill:retro` renders it.

Makes the project's AI-assisted work history visible. "This week: 3 /skill:review,
2 /skill:ship, 1 /skill:investigate across branches feature-auth and fix-billing."
...
### Layer 5: /skill:health (opt-in skill)
Code quality dashboard: type-check, lint, test suite, dead code scan.
Composite 0-10 score. Tracks over time. `/skill:retro` shows trends. `/skill:ship`
