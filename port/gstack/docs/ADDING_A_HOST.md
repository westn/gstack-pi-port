...
const myhost: HostConfig = {
  ...
  pathRewrites: [
    { from: '~/.pi/agent/skills/gstack', to: '~/.myhost/skills/gstack' },
    { from: '.pi/skills/gstack', to: '.myhost/skills/gstack' },
    { from: '.pi/skills', to: '.myhost/skills' },
  ],
...
# Verify output exists and has no .pi/skills leakage
ls .myhost/skills/gstack-*/SKILL.md
grep -r ".pi/skills" .myhost/skills/ | head -5
# (should be empty)
