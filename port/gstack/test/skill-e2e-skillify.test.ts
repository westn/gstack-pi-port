 ...
 *   - The /scrape and /skillify skills installed under .pi/skills/
...
Do NOT enter the prototype phase. Do NOT ask the user in chat.`,
...
2. Run /skillify via the Skill tool. Follow ALL 11 steps including:
   ...
   - When ask the user in chat fires, choose the recommended option (A)
...
2. Run /skillify via the Skill tool. Follow steps 1-9. When the approval
   gate ask the user in chat fires (Step 9), choose option C (Discard) instead
