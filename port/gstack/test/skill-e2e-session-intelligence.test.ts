...
- Look for "RECENT ARTIFACTS" and "LAST_SESSION" in the output.`,
  ...
  // Hand-feed the save section of context-save/SKILL.md to pi --mode json -p and verify
...
- Do NOT ask the user in chat.`,
  ...
  // pi --mode json -p. Verify the agent identifies the newer file (by filename prefix)
...
- Do NOT ask the user in chat. Just present the content of the newest file.`,
      workingDirectory: workDir,
      maxTurns: 8,
