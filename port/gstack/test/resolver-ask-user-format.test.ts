/**
 * ask the user in chat Format resolver — gate-tier assertions on the generated
...
describe('generateAskUserFormat — v1.7.0.0 Pros/Cons format', () => {
  ...
  test('includes ask the user in chat Format header', () => {
    expect(out).toContain('## User Question Format');
  });
