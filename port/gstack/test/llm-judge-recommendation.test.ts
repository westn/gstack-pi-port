...
// Fixtures wrap a realistic ask the user in chat shape so the judge sees the menu
...
Net: ...`);
    ...
    // no-fix vs fix). The same rubric the ask the user in chat judge uses applies:
