/**
 * /plan-design-review per-finding ask the user in chat count (periodic, paid, real-PTY).
 *
...
describeE2E('/plan-design-review per-finding ask the user in chat count (periodic)', () => {
  test(
    `5-finding plan emits ${FLOOR}-${CEILING} review-phase ask the user in chats`,
    async () => {
      try {
