/**
 * /plan-eng-review per-finding ask the user in chat count (periodic, paid, real-PTY).
 *
...
describeE2E('/plan-eng-review per-finding ask the user in chat count (periodic)', () => {
  test(
