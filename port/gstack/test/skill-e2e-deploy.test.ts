...
describeIfSelected('Land-and-Deploy skill E2E', ['land-and-deploy-workflow'], () => {
  ...
  test('/skill:land-and-deploy detects Fly.io platform and produces deploy report structure', async () => {
...
4. Write the deploy configuration to AGENTS.md
...
Do NOT ask the user in chat. Do NOT run gh or fly commands.`,
...
describeIfSelected('Canary skill E2E', ['canary-workflow'], () => {
  ...
  test('/skill:canary skill produces monitoring report structure', async () => {
    const result = await runSkillTest({
...
Do NOT ask the user in chat. Do NOT run browse ($B) commands.
...
describeIfSelected('Benchmark skill E2E', ['benchmark-workflow'], () => {
  ...
  test('/skill:benchmark skill produces performance report structure', async () => {
    const result = await runSkillTest({
...
describeIfSelected('Setup-Deploy skill E2E', ['setup-deploy-workflow'], () => {
  ...
  test('/skill:setup-deploy detects Fly.io and writes config to AGENTS.md', async () => {
    const result = await runSkillTest({
...
5. Write the Deploy Configuration section to AGENTS.md

Do NOT ask the user in chat. Do NOT run fly or gh commands.
