 ...
 *
 * History: in April 2026 pi shipped /checkpoint as a native alias
 ...
 *
 * Maintenance: when pi (or any other host we support) ships a new
...
const KNOWN_BUILTINS: Record<string, string[]> = {
  'claude-code': [
    ...
    // Sources:
    //   https://code.pi.com/docs/en/checkpointing
    //   https://claudelog.com/mechanics/rewind/
    //   claude --help output
    //   pi skill list dumps from live sessions
    'agents',         // Agent config
    'bare',           // Minimal mode
  ...
  // built-in lists when we encounter collisions. pi is the primary
