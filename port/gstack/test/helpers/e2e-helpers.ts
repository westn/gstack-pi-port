...
/**
 * Run judgeRecommendation on a captured ask the user in chat text, record the score
 ...
 * ask the user in chat. Returns the score for tests that want to inspect it
 * further.
 */
