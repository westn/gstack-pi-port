 ...
 *       Used by the ask the user in chat format-compliance and mode-routing tests to look
...
describe('parseNumberedOptions', () => {
  ...
  test('anchors on LAST cursor when both stale and fresh fit in the tail', () => {
    ...
    // permission dialog options come first, the real ask the user in chat comes second.
