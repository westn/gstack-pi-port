...
## Product Context
- **What this is:** Community website for gstack — a CLI tool that turns pi into a virtual engineering team
...
|------|----------|-----------|
| 2026-03-21 | Initial design system | Created by /skill:design-consultation. Industrial aesthetic, warm amber accent, Satoshi + DM Sans + JetBrains Mono. |
