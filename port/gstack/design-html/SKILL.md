...
# /skill:design-html: Pretext-Native HTML Engine
...
If a framework is detected, ask the user in chat:
...
Maximum 10 iterations. If the user hasn't said "done" after 10, ask the user in chat:
...
> and create a DESIGN.md for your project. This means future /skill:design-shotgun and
> /skill:design-html runs will be style-consistent automatically.
