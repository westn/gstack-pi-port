...
# /skill:design-consultation: Your Design System, Built Together
...
If the codebase is empty and purpose is unclear, say: *"I don't have a clear picture of what you're building yet. Want to explore first with `/skill:office-hours`? Once we know the product direction, we can set up the design system."*
...
**ask the user in chat Q1 — include ALL of these:**
...
Each drill-down is one focused ask the user in chat. After the user decides, re-check coherence with the rest of the system.
...
"Want to see this design system as working Pretext-native HTML? Run /skill:design-html."
...
```bash
~/.pi/agent/skills/gstack/bin/gstack-learnings-log '{"skill":"design-consultation","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
