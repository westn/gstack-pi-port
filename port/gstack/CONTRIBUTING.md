...
For template authoring best practices (natural language over bash-isms, dynamic branch detection, `{{BASE_BRANCH_DETECT}}` usage), see AGENTS.md (or CLAUDE.md)'s "Writing SKILL templates" section.
